      ...
      <Container className="mt-4">
        <Row>
          ...
          <Col md={6} className="text-center">
            <img className="landing-img" src="/images/gpback.jpg" alt="main-tree" />
            <div className="landing-tagline">
              See how your daily actions can <span className="landing-add">ADD</span> up to better world
            </div>
            ...
            <Row className="justify-content-center mt-2">
              ...
              <div className="float-left text-center floatdown ml-4">
                {" "}
                <img src="../images/lifestyle.jpg" alt="thumb-lifestyle" />
                <div>Lifestyle</div>
              </div>
              <div className="float-left text-center floatdown ml-4">
                {" "}
                <img src="../images/transportation.jpg" alt="thumb-transpo" />
